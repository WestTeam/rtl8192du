...
ifeq ($(CONFIG_PLATFORM_ARM_DE0), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
EXTRA_CFLAGS += -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
ARCH := arm
CROSS_COMPILE :=/home/westbot/Documents/Robotics/low-level/gcc-linaro-6.1.1-2016.08-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf- 
KVER  := 4.9.78-ltsi+
KSRC ?=/home/westbot/Documents/Robotics/low-level/linux-socfpga 
endif
